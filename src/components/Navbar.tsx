...
const Navbar = () => {
  return (
    <div>
      <header className="p-4 px-10 dark:bg-gray-100 dark:text-gray-800">
	<div className="container flex justify-between h-16 mx-auto" >
		...
		<div className="items-center flex-shrink-0 hidden lg:flex" >
			...
			<button className="self-center px-8 py-3 font-semibold rounded dark:bg-violet-600 dark:text-gray-50">M360 ICT</button>
		</div>
